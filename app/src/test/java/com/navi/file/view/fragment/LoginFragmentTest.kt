...
class LoginFragmentFactory(
    ...
    override fun instantiate(classLoader: ClassLoader, className: String): Fragment {
        return when (className) {
            LoginFragment::class.java.name -> LoginFragment(loginViewModelFactory)
...
class LoginFragmentTest: ViewModelTestHelper() {
    ...
    private fun createFragmentScenario() {
        ...
        val loginFragmentFactory = LoginFragmentFactory(createViewModelFactory(mockLoginViewModel))
